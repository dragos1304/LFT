...
// Initialize Firebase app + auth (modular way)
...
initializeNewStudySetData("user1", {
  ...
  summary_text:
    "A foundational look at the structure and function of cells, the basic building blocks of life.",
  hierarchical_outline: {
    topic: "Cells",
    details: ["The basic unit of life"],
    children: [],
  },
  keywords: [
    {
      text: "Nucleus",
      definition: "The control center of the cell.",
      source_sentence: "The nucleus contains the cell's genetic material.",
      ai_importance_score: 5,
    },
  ],
  flashcards: [
    {
      front_text: "What is the powerhouse of the cell?",
      back_text: "The Mitochondria",
    },
  ],
  practice_questions: [
    {
      ...
      ai_grading_rubric: "Ribosomes are the sites of protein synthesis.",
    },
  ],
});